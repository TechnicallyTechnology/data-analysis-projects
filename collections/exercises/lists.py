...
adding_practice = [273.15, 42, "hello"]
print(adding_practice)
...
cargo_hold = ['oxygen tanks', 'space suits', 'parrot', 'instruction manual', 'meal packs', 'space tether', 'security blanket']
...
cargo_hold = ['oxygen tanks', 'space suits', 'parrot', 'instruction manual', 'meal packs', 'space tether']
...
cargo_hold = ['space suits', 'parrot', 'instruction manual', 'meal packs', 'space tether']
...
cargo_hold = [1138, 'space suits', 'instruction manual', 'meal packs', 'space tether', '20 meters']
